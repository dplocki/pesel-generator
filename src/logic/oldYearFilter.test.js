...
it('Providing years old should be calculate to date', () => {
  expect(oldYearFilter(SignEnum.Equal, '12', moment('20181012')).isSame(moment('20061012'))).toBe(true);
});

it('Providing more than years old should be calculate to proper birth date', () => {
  expect(oldYearFilter(SignEnum.Lesser, '12', moment('20190410')).isAfter(moment('20070410'))).toBe(true);
});

it('Providing exact number of years old should be calculate to birth date', () => {
  expect(oldYearFilter(SignEnum.Greater, '12', moment('20190410')).isBefore(moment('20070410'))).toBe(true);
});
